...
export const galleryItems = [
  ...
  {
    type: "image",
    title: "Botella y copa",
    text: "Detalle de servicio para cata privada, packs de tienda y regalos personalizados.",
    src: "images/still-life.jpg",
  },
  {
    type: "image",
    title: "Archivo de barricas",
    text: "Zona de crianza para reservas limitadas, catas verticales y partidas de guarda.",
    src: "images/hero-cellar.jpg",
  },
] as const;
